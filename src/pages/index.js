  ...
  return (
    <Layout>
      <div className="about-card flex-wrap flex-md-nowrap justify-content-center">
        ...
        <div>
          <p><strong>Mitchell</strong> (he/him/his) is a software engineer and performing artist based in Chicago, IL. 
          Check out <Link to="/tech">some recent projects</Link>, or <Link to="/contact">get in touch</Link>.</p>
          <p><strong>keywords:</strong></p>
          <p>
            tech: react &mdash; redux &mdash; graphQL &mdash; node &mdash; systems 
          </p>
          <p>
